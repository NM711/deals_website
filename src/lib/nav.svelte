<script>
  ...
  let listActive =
    "opacity-100 duration-300 ease-in-out translate-x-0";
...
<nav {...$$props} class="{navBg} {navText} {navFont} fixed z-[100] w-full shadow-sm shadow-black">
  <div class="flex justify-between items-center {navPadding}">
    ...
    <ul
      ...
      <li class="md:mx-3 md:px-3 md:py-0 py-3">
        <a class="hover:text-yellow-500 duration-150 ease-in-out" href={itemHref1}>{itemName1}</a>
      </li>
      <li class="md:mx-3 md:px-3 md:py-0 py-3">
        <a class="hover:text-yellow-500 duration-150 ease-in-out" href={itemHref2}>{itemName2}</a>
      </li>
      <li class="md:mx-3 md:px-3 md:py-0 py-3">
        <a class="hover:text-yellow-500 duration-150 ease-in-out" href="/deals?index=0">Deals</a>
      </li>
        <button on:click={toggleCategories} class="md:mx-3 md:px-3 md:py-0 py-3 cursor-pointer text-3xl hover:text-yellow-500 duration-150 ease-in-out">
          <ion-icon class="visible md:block hidden" name="apps-sharp"></ion-icon>
          <p class="md:hidden block">Categories</p>
        </button>
    </ul>
    
      <ul class="block fixed py-3 top-0 left-0 h-screen md:w-[25vw] w-[50vw] md:text-4xl text-3xl text-center shadow-md shadow-black {navBg} {categoriesListTranslateClasses}">
        <li class="md:mx-3 md:px-3 py-3 text-yellow-500 duration-150 ease-in-out">
          Brands
        </li>
        <li class="md:mx-3 md:px-3 py-3 cursor-pointer hover:text-yellow-500 duration-150 ease-in-out">
          <a href="/headlines/BREAKING%20NEWS">Hp</a>
        </li>
        <li class="md:mx-3 md:px-3 py-3 cursor-pointer hover:text-yellow-500 duration-150 ease-in-out">
          <a href="/headlines/US%20NEWS">Acer</a>
        </li>
        <li class="md:mx-3 md:px-3 py-3 cursor-pointer hover:text-yellow-500 duration-150 ease-in-out">
          <a href="/headlines/WORLD%20NEWS">Lenovo</a>
        </li>
      </ul>
