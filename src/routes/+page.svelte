<header class="col-span-4 h-screen bg-cover bg-[url('/banner.jpg')] mt-32">
    <div id="banner-overlay" class="absolute z-10 w-full h-screen bg-black bg-opacity-50"></div>
    <div class="flex absolute z-20 w-screen md:h-[85vh] h-[75vh] text-Snow font-Expose">
        <img src="/tilt.svg" alt="tilt-svg" class="w-full"/>
